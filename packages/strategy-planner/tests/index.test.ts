...
describe('Strategy Planner API', () => {
  ...
  describe('POST /plan', () => {
    ...
    it('should include trace ID from headers', async () => {
      ...
      const response = await request(app).post('/plan').set('x-trace-id', traceId).send({
        prompt: 'Test prompt',
      })
  ...
  describe('POST /plan/quick', () => {
    it('should handle quick planning requests', async () => {
      const response = await request(app).post('/plan/quick').send({
        task_type: 'reasoning',
      })
    ...
    it('should complete quickly', async () => {
      ...
      await request(app).post('/plan/quick').send({ task_type: 'coding' })
