...
import type { PromptVariant, TaskClassification, BudgetConstraints } from '@promptdial/shared'
...
class TestTechnique extends BaseTechnique {
  ...
  async generate(
    ...
    const variant = this.createVariant(this.sandwichPrompt(base_prompt), this.name, 0.7, 0)
...
describe('BaseTechnique', () => {
  ...
  describe('createVariant', () => {
    it('should create a variant with correct properties', () => {
      ...
      const variant = technique['createVariant'](prompt, 'test_technique', 0.7, 0)
