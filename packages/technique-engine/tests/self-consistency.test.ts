...
import { SelfConsistencyTechnique, SELF_CONSISTENCY_VOTE_PROMPT } from '../src/techniques/self-consistency'
import {
...
describe('SelfConsistencyTechnique', () => {
  ...
  describe('generate', () => {
    it('should generate self-consistency variants with multiple samples', async () => {
      const basePrompt = 'If John is older than Mary, and Mary is older than Tom, who is the youngest?'
