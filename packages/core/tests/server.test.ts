...
describe('Server', () => {
  ...
  describe('API Endpoints', () => {
    ...
    describe('POST /api/optimize', () => {
      ...
      it('should handle optimization errors gracefully', async () => {
        ...
        expect(console.error).toHaveBeenCalledWith('❌ Optimization error:', expect.any(Error))
      })
  ...
  describe('Server startup', () => {
    ...
    it('should log startup message with API keys status', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('OpenAI, Anthropic'))
    })
    ...
    it('should log warning when no API keys are configured', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(expect.stringContaining('No API keys found'))
    })
  })
  ...
  describe('Middleware setup', () => {
    it('should configure CORS', async () => {
      ...
      const response = await request(app).options('/api/optimize').expect(204)
