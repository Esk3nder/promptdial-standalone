  ...
  describe('generateMultiple', () => {
    it('should generate multiple responses', async () => {
      mockProvider = new MockProvider(
        { provider: 'test', api_key: 'key' },
        ['Response 1', 'Response 2', 'Response 3']
      )
      
      const variant = createTestPromptVariant()
      const responses = await handler.generateMultiple(
        mockProvider,
        variant,
        3
      )
  ...
  describe('analyzeConsistency', () => {
    it('should identify consistent responses', () => {
      const responses: LLMResponse[] = [
        { content: 'The answer is 42', tokens_used: 10, latency_ms: 100, provider: 'test', model: 'test' },
        { content: 'The answer is 42', tokens_used: 10, latency_ms: 100, provider: 'test', model: 'test' },
        { content: 'The answer is 42', tokens_used: 10, latency_ms: 100, provider: 'test', model: 'test' }
      ]
